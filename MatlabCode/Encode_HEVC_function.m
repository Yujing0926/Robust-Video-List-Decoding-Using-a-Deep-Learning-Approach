function [] = Encode_HEVC_function(MainRouteResult,videonames,QPlist,APPEND_CHAR)
%% Inputs
...
OriginalYuvRoute=[MainRouteResult APPEND_CHAR '1080p_rawSequence'];
OutRoute = [MainRouteResult APPEND_CHAR '1080p_videos' APPEND_CHAR];
if (~exist(OutRoute))
    mkdir(OutRoute);
end

OutRouteResult=[MainRouteResult APPEND_CHAR '1080p_videos' APPEND_CHAR SEQUENCE_NAME APPEND_CHAR 'HEVC' APPEND_CHAR 'encoding'];
